        ...
        <nav className='bg-mainBlue py-3 lg:py-0 lg:h-24 w-full flex items-center shadow-md'>
            <div className='container mx-auto flex flex-col lg:flex-row justify-between items-center gap-5 lg:gap-0 px-4'>
                ...
                <div className='flex items-center bg-white rounded-full shadow-lg'>
                    ...
                    className='rounded-l-full px-6 py-3 outline-none flex-grow' 
                    name='searchTitle'
                    value={currentSearch}
                    onChange={handleInputSearch}
                    />
                    <button 
                    className='rounded-r-full px-6 py-3 bg-mainOrange text-textWhite hover:bg-orange-600 transition'
