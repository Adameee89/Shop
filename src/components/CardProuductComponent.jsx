...
function CardProductComponent({ product }) {
  return (
    <div className='max-w-sm w-full bg-white rounded-lg border border-gray-300 shadow-md overflow-hidden transform transition-all duration-300 hover:shadow-2xl hover:scale-105'>
      {/* Image Section */}
